...
const Button = forwardRef(
  (
    { children, onClick, variant, localStyling }: ButtonProps,
    ...
    const outline =
      "text-[#575555] bg-transparent border border-black hover:bg-[#C8C8C8] font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800";
